package com.heinqi.support.widget.recycleview.view;
...
public class PullLoadMoreRecyclerView extends LinearLayout {
    ...
    public PullLoadMoreRecyclerView(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray attr = context.obtainStyledAttributes(attrs, R.styleable.PullLoadMoreRecyclerView, 0, 0);
    ...
    private void initView(Context context) {
        mContext = context;
        View view = LayoutInflater.from(context).inflate(R.layout.view_base_m_pull_load_more, null);
        mSwipeRefreshLayout = (SwipeRefreshLayout) view.findViewById(R.id.swipeRefreshLayout);
        mSwipeRefreshLayout.setColorSchemeResources(android.R.color.holo_green_dark, android.R.color.holo_blue_dark, android.R.color.holo_orange_dark);
        mSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayoutOnRefresh(this));
        tvNoDate = (TextView) view.findViewById(R.id.tv_no_date);
    ...
    public void showNoDataView(int visible) {
        iv_no_data.setVisibility(visible);
        tvNoDate.setVisibility(GONE);
    }
    ...
    private int mDownstartY;            // 按下点的x值
    private int mUpEndY;            // 按下点的y值
